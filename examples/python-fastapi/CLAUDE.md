...
- **Run `ruff check .` and `pytest` before and after changes** — You cannot distinguish pre-existing failures from regressions without a baseline; never declare done without passing lint + tests
